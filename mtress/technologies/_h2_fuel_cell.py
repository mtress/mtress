...
from ..physics import H2_LHV, HYDROGEN
...
class PEMFuelCell(AbstractTechnology, AbstractSolphRepresentation):
    ...
    reached, if excess could be recovered. However, the behaviour of FC is non-linear
    ...
    Operating temperature of PEMFC could range between 50-100 °C, making them suitable
    for space heating and boiling water for residential, commercial building, and/or
    industrial processes, etc. For instance, the H2home project demonstrated the use of
    PEMFC-based combined heat and power (CHP) systems for residential buildings. Ongoing
    ...
    circulates cooling liquid is used to extract heat for PEMFC and cathode air flow
    for SOFC.
    ...
    def build_core(self):
        ...
        # scenario, that's why the lower end electrical and thermal efficiency is
        ...
        # PEM Fuel cell generates waste heat at around 60-80 °C, considered 70 °C in
        # this implementation. "Prospects of Fuel Cell Combined Heat and Power Systems"
        # by AG. Olabi et. al.
