...
def test_demand_only():
    ...
    electricity_demand_adjacent = [0.1, 0.3, 0.0]
...
def test_adjacent_renewables():
    ...
    electricity_demand_local = [0.2, 0.1, 0.05]
    pv_generation = [0.25, 0.15, 0]
    electricity_supply_adjacent = [0.4, 0, 0]
...
def test_adjacent_renewables_no_bonus():
    electricity_demand_adjacent = np.full(3, 0.1)
    electricity_demand_local = [0.2, 0.1, 0.05]
    pv_generation = [0.25, 0.15, 0]
    electricity_supply_adjacent = [0.4, 0, 0]
...
if __name__ == '__main__':
    test_adjacent_renewables_no_bonus()
