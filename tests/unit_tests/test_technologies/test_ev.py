...
class TestGenericElectricVehicle:
    ...
    def check_ev_obj(
        ...
        assert ev.plugged_in_profile == 0.0
    ...
    @pytest.mark.parametrize(
        ...
        [
         # lists, Real
         (GenericSegmentB_EV, [0, 1e3, 0], [1, 0, 1], 1e3*2/3, 
          187842.23850875002
          ), 
         # Series, Real
         (GenericSegmentB_EV,
         ...
         # lists, list
         (GenericSegmentB_EV, [0, 1e3, 0], [1, 0, 1], [0, 1e3, 1e3], 
          191008.86842105
          ), 
         # lists, Series
         (GenericSegmentB_EV, 
         ...
         # ********************************************************************
         # lists, Real
         (GenericSegmentB_EV, [0, 1e4, 0], [1, 0, 1], 1e4*2/3, 
          289842.55429825
          ), 
         # Series, Real
         (GenericSegmentB_EV,
         ...
         # lists, list
         (GenericSegmentB_EV, [0, 1e4, 0], [1, 0, 1], [0, 1e4, 1e4], 
          323831.58342105
          ), 
         # lists, Series
         (GenericSegmentB_EV, 
         ...
         # lists, Real
         (GenericSegmentC_EV, [0, 1e3, 0], [1, 0, 1], 1e3*2/3, 
          164092.48430555002
          ), 
         # Series, Real
         (GenericSegmentC_EV,
         ...
         # lists, list
         (GenericSegmentC_EV, [0, 1e3, 0], [1, 0, 1], [0, 1e3, 1e3], 
          167259.11458335
          ), 
         # lists, Series
         (GenericSegmentC_EV, 
         ...
         # lists, Real
         (GenericSegmentC_EV, [0, 1e4, 0], [1, 0, 1], 1e4*2/3, 
          266092.79680555
          ), 
         # Series, Real
         (GenericSegmentC_EV,
         ...
         # lists, list
         (GenericSegmentC_EV, [0, 1e4, 0], [1, 0, 1], [0, 1e4, 1e4], 
          297759.11458335
          ), 
         # lists, Series
         (GenericSegmentC_EV, 
...
class TestElectricVehicle:
    ...
    @pytest.mark.parametrize(
        ...
        [
         ...
         # Series, Real
         (GenericSegmentB_EV,
          Series(data=[0, 1e3/GenericSegmentB_EV.consumption_per_distance, 0]),
          Series(data=[1, 0, 1]),
          1e3*2/3, 
          187842.23850875002
          ), 
         ...
         # Series, Real
         (GenericSegmentB_EV,
          Series(data=[0, 1e4/GenericSegmentB_EV.consumption_per_distance, 0]),
          Series(data=[1, 0, 1]),
          1e4*2/3, 
          289842.55429825
          ), 
         ...
         # Series, Real
         (GenericSegmentC_EV,
          Series(data=[0, 1e3/GenericSegmentC_EV.consumption_per_distance, 0]),
          Series(data=[1, 0, 1]),
          1e3*2/3, 
          164092.48430555002
          ), 
         ...
         # Series, Real
         (GenericSegmentC_EV,
          Series(data=[0, 1e4/GenericSegmentC_EV.consumption_per_distance, 0]),
          Series(data=[1, 0, 1]),
          1e4*2/3, 
          266092.79680555
          ), 
