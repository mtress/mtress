...
class TestOffsetCHP:
    ...
    @pytest.mark.parametrize(
        "template, expected_result, normalised_min_load",
        [
            # ignore min load: should match results for CHP class
            (NATURALGAS_CHP, 0.8508048112500001, 0.0),
            (BIOGAS_CHP, 58187714401.612885, 0.0),
            (BIOMETHANE_CHP, 0.7855700564999999, 0.0),
            (HYDROGEN_CHP, 0.32534810449999996, 0.0),
            (HYDROGEN_MIXED_CHP, 1307692350000.05, 0.0),
            (AET100NG_CHP, 0.8077001939999999, 0.0),
            # use min load from template
            (NATURALGAS_CHP, 1307692350000.05, None),
            (BIOGAS_CHP, 1307692350000.05, None),
            (BIOMETHANE_CHP, 1307692350000.05, None),
            (HYDROGEN_CHP, 1285714240000.05, None),
            (HYDROGEN_MIXED_CHP, 1307692350000.05, None),
            (AET100NG_CHP,  1222222210000.05, None),
        ],
    )
    def test_chp(
            self, template: CHPTemplate, 
        ...
        if normalised_min_load is None:
            ...
            chp = OffsetCHP("chp", template=template)
