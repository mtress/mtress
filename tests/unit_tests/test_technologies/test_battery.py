...
class TestBatteryStorage:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (0.22234156820622974, False, False, 
             0, [3.0, 0.222342, 0], [3.0, 0, 0]),
            ...
            # case 1: surplus of 0.1 leads to charging and discharging
            (0.1, False, True, 
             None, [1.349275, 0.1, 0], [1.349275, 0, 0]),
            # case 2: surplus leading to peak charging and discharging
            (0.22234156820622974, False, True, 
             None, [3.0, 0.222342, 0], [3.0, 0, 0]),
            # case 3: simultaneous charging and discharging in multiple steps
            (0.3, False, True, 
             None, [3.0, 1.347826, 0], [3.0, 1.047826, 0])
        ],
    )
    def test_bs_limit(
            self, 
