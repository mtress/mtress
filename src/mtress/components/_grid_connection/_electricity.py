...
class ElectricityGridConnection(AbstractTechnology):
    ...
    def _build_core(self):
        ...
        self.inbound_interfaces.add(self.grid_import)
        self.inbound_interfaces.add(self.grid_export)
        self.outbound_interfaces.add(self.grid_import)
        self.outbound_interfaces.add(self.grid_export)
