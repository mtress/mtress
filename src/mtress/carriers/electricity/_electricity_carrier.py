...
class ElectricityCarrier(AbstractCarrier):
    ...
    def _build_core(self):
        ...
        self.inbound_interfaces.add(self.distribution)
        self.inbound_interfaces.add(self.feed_in)
        self.outbound_interfaces.add(self.distribution)
        self.outbound_interfaces.add(self.feed_in)
